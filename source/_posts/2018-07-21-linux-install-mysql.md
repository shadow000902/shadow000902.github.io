...
2. 如果安装中出现各种莫名其妙的问题，说明环境有问题，处理方法是卸载掉所有mysql相关的库，然后重新安装 需要用到的主要是`dpkg`命令
   ...
   可以看到所有系统已经安装的，或者是之前有人安装的mysql 我们需要做的是先卸载这些所有的库，只要是名称上有mysql的全部卸载掉，命令为：
