...
# 2017-01-11-Webpy-database-operation-introduction
...
默认情况下，brew安装的MySQL是没有root密码的，基于安全考虑，需要设置一个密码 执行`mysql_secure_installation`命令后，跟着提示步骤走就可以了
